Hypervisor is a small software layer that enables multiple instances of [[Operating System]] to run alongside each other, sharing the same physical computing resources. 
